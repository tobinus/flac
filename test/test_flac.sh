...
# rt_test_w64 wacky_cbsize0.w64 '--keep-foreign-metadata'  # cbSize = 0 not supported for WAVE64
...
# rt_test_w64_autokf wacky_cbsize0.w64 '--keep-foreign-metadata'  # cbSize = 0 not supported for WAVE64
